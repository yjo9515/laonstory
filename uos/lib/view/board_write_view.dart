...
class BoardWriteView extends GetView<BoardWriteViewModel> {
  BoardWriteView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: GetBuilder<BoardWriteViewModel>(
            init: BoardWriteViewModel(),
            builder: (_) => SafeArea(
