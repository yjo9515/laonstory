...
import '../view_model/notice_edit_view_model.dart';

class NoticeEditView extends GetView<NoticeEditViewModel> {
  NoticeEditView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: GetBuilder<NoticeEditViewModel>(
            init: NoticeEditViewModel(),
            builder: (_) => SafeArea(
