...
class AddRoomForthPage extends StatelessWidget {
  const AddRoomForthPage({Key? key, required this.bloc}) : super(key: key);
                  ...
                  child: Container(
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: <TextSpan>[
                          TextSpan(text: '(4/8)', style: context.textTheme.krSubtitle1.copyWith(color: mainJeJuBlue)),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: state.facilities.entries.map((e) {
                              return ['침구', '청소/소모품', '욕실 용품', '보안/안전', '여가시설'].indexWhere((element) => element == e.key!) != -1
                        ...
                        Padding(
                          ...
                          child: LargeButton(
                            onTap: () {
                              context.pushNamed('room', extra: bloc, pathParameters: {'path': 'add'}, queryParameters: {'step': '5'});
                            },
                            text: '다음',
                          ),
                        ),
