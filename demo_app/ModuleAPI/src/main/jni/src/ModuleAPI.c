...
JNIEXPORT jint JNICALL Java_com_laonstory_linenseoul_ModuleAPI_SerailOpen(JNIEnv* env, jobject thiz, jstring juart,jint baudrate, jint databits,jint stopbits, jint check) {
    jboolean iscopy;
...
JNIEXPORT jint JNICALL Java_com_laonstory_linenseoul_ModuleAPI_SerailSendData(JNIEnv *env, jobject thiz, int uart_fd,jbyteArray send_data,int sendLen) {
...
JNIEXPORT jint JNICALL Java_com_laonstory_linenseoul_ModuleAPI_SerailReceive(JNIEnv *env, jobject thiz, jint uart_fd,jbyteArray receive_data,int receive_dataLen) {
...
JNIEXPORT jint JNICALL Java_com_laonstory_linenseoul_ModuleAPI_CalcCRC(JNIEnv *env, jobject thiz, jbyteArray jdata, jint data_len,jbyteArray jout_crc){
